...
public class ProfMethodAdapter extends MethodAdapter {
    ...
    private static Logger log = LoggerFactory.getLogger(ProfMethodAdapter.class);
    /**
     * 方法ID
     */
    ...
    public ProfMethodAdapter(MethodVisitor visitor, String fileName, String className, String methodName) {
        ...
        log.debug(String.format("init ProfMethodAdapter for %s:%s()", className, methodName));
        log.debug("method id:" + String.valueOf(mMethodId));
