...
public class MethodCache {
	...
	private static Logger log = LoggerFactory.getLogger(MethodCache.class);
	 ...
	 * 方法名writer
	 */
	private static DailyRollingFileWriter fileWriter = new DailyRollingFileWriter(ProfConfig.getInstance().getMethodFilePath());
	...
	public static   Vector<MethodInfo> getCacheMethods(){
		return mCacheMethods;
	}
	...
	public synchronized static void flushMethodData() {
        log.info("flush method data [start]");
		...
		fileWriter.flushAppend();
		log.info("flush method data [end]");
	}
}
