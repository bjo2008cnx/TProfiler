 ...
 * @since 15/5/25
 */
public abstract class AbstractMethodAdapter extends MethodAdapter {
    ...
    public AbstractMethodAdapter(MethodVisitor methodVisitor, String fileName, String className, String methodName) {
        super(methodVisitor);
