 ...
 * @since 2015-6-1
 */
public class MysqlProfClassAdapter extends AbstractClassAdapter {
	 ...
	 * @return
	 */
	private AbstractMethodAdapter record(final MethodVisitor mv, final String name, final String descriptor) {
		return new AbstractMethodAdapter(mv,"",name,descriptor){
	 ...
	 * @return
	 */
	private AbstractMethodAdapter getMethodAdapter(MethodVisitor mv,String name,String descriptor){
...
//					System.out.println(descriptor);
	...
	public MethodVisitor visitMethod(int arg, String name, String descriptor, String signature, String[] exceptions) {
		...
		AbstractMethodAdapter methodAdapter = getMethodAdapter(mv,name,descriptor);
